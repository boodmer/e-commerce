			...
			array(
				...
				'fields'          => array(
					array(
						'type'    => 'notice',
						'style'   => 'normal',
						'content' => __( 'Want to customize everything (typography, color, and margin) easily? <a href="https://shapedplugin.com/plugin/woocommerce-category-slider-pro/?ref=115" target="_blank"><b>Upgrade to Pro</b></a> P.S. Note: The color and margin options work in the lite version.', 'woo-category-slider-grid' ),
					),
					array(
